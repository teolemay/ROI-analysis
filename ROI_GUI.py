...
class Lifetime_Map_Window(QtWidgets.QMainWindow):
    ...
    def apply_changes(self):
        ...
        plt.figure(num=self.hist_num)
        self.histCanvas.wipe()
        custom_lifetime_vals = self.lifetime_vals[self.lifetime_vals <= self.taumax]
        custom_lifetime_vals = custom_lifetime_vals[custom_lifetime_vals >= self.taumin]
        n, _bins, _patches = self.histCanvas.ax.hist(custom_lifetime_vals, 'auto')
        self.histCanvas.ax.set(xlabel='Lifetimes (s)', ylabel='Count')
        self.histCanvas.fig.canvas.draw_idle()
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.donorFLIMimage.ax.imshow(plt.imread(dir_path + '\\' + 'ROI_functions_images\\none.png'))
        ...
        self.secondaryImage.ax.imshow(plt.imread(dir_path + '\\'+ 'ROI_functions_images\\none.png'))
    ...
    def get_files(self):
        ...
        try:
            ...
            self.donorFLIMimage.wipe()
            self.donorFLIMimage.ax.imshow(plt.imread(dir_path + '\\' + 'ROI_functions_images\\bad_path.png'))
            self.donorFLIMimage.fig.canvas.draw_idle()
            self.secondaryImage.wipe()
            self.secondaryImage.ax.imshow(plt.imread(dir_path + '\\' + 'ROI_functions_images\\bad_path.png'))
            self.secondaryImage.fig.canvas.draw_idle()
